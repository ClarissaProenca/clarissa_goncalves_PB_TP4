...
for resultado in resultados_ex3:
    nome_projeto, nome_departamento, custo_total = resultado
    print(f'Projeto: {nome_projeto}, Departamento: {nome_departamento}, Cargo: {custo_total}')
...
dados_ex3 = [{"projeto": nome_projeto, "departamento": nome_departamento, "custo_total": custo_total}
             for nome_projeto, nome_departamento, custo_total in resultados_ex3]
